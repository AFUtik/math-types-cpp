...
### Использование
На данный момент доступны следующие примитивы: vector, matrix.
Пример создания экземпляров и их использования представлен ниже. В векторах разрешено использовать структуры.
Все тонкости работы с векторами описаны далее.
